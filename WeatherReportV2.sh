...
printf "# Rapport météorologique de Nantes \n\n" > "/home/pgaill/projet_AdminLinux/reportV2.md"
date=`date +"%d-%m-%Y"`
printf "**Jour**: $date \n">> "/home/pgaill/projet_AdminLinux/reportV2.md"
...
do
    ...
    then 
        ...
        printf '|%4s%6s|' "$i" >> "/home/pgaill/projet_AdminLinux/reportV2.md"
        printf '%6.1f%6s|\n' "$value" >> "/home/pgaill/projet_AdminLinux/reportV2.md"
...
`pandoc reportV2.md -o report.pdf`
